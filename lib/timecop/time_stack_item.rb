  ...
  class TimeStackItem #:nodoc:
    ...
    def datetime(datetime_klass = DateTime)
      ...
      if Float.method_defined?(:to_r)
        ...
        datetime_klass.new(current_time.year, current_time.month, current_time.day, current_time.hour, current_time.min, (fractions_of_a_second + current_time.sec), utc_offset_to_rational(current_time.utc_offset))
      else
        datetime_klass.new(current_time.year, current_time.month, current_time.day, current_time.hour, current_time.min, current_time.sec, utc_offset_to_rational(current_time.utc_offset))
      end
    end
